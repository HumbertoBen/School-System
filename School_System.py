...
label = Label(text="SIMPLE SCHOOL MANAGEMENT SYSTEM IN PYTHON", font=("times new roman", 35), bg="black", fg="white")
    ...
    def studentid():
        ...
        with conn:
            ...
            for row1 in cur.fetchall():
                chat1.insert('', 0, text=row1 &  # 91;0], values=(row1&#91;1] ,row1&#91;2],row1&#91;3]))
    ...
    def viewenquiry2():
        ...
        with conn:
            ...
            for row in cur.fetchall():
                chat1.insert('', 0, text=row &  # 91;0], values=(row&#91;1], row&#91;2], row&#91;3]))

    def distroy5():
        secondw.destroy()
        window()

    mainlabel = Label(secondw, text="SIMPLE SCHOOL MANAGEMENT SYSTEM IN PYTHON", font=("times new roman", 35),
                      bg="black", fg="white")
    mainlabel.pack(side=TOP, fill=X)
    button = Button(secondw, width=15, font=("arial", 20), text="REGISTRATION", bg="black", fg="white",
                    command=distroy4)
    button.place(x=10, y=480)
    enquiry = Button(secondw, width=15, font=("arial", 20), text="FEE DETAILS", bg="black", fg="white",
                     command=distroy5)
    enquiry.place(x=280, y=480)
    fee_details = Button(secondw, width=15, font=("arial", 20), text="ENQUIRY", bg="black", fg="white",
                         command=enquiry1)
    fee_details.place(x=560, y=480)
    viewenquiry = Button(secondw, width=15, font=("arial", 20), text="VIEW ENQUIRY", bg="black", fg="white",
                         command=viewenquiry2)
    viewenquiry.place(x=840, y=480)
    viewenquiry1 = Button(secondw, width=15, font=("arial", 20), text="STUDENT DETAILS", bg="black", fg="white",
                          command=studentid)
...
def root():
    ...
    box &  # 91;'values']=&#91;'SELECT','COMPUTER SCIENCE','MACHENICAL','CIVIL','IT']
    box.current(0)
    ...
    button1 = Button(root, text="CALCULATE FEE", width=14, font=("arial", 10), bg="black", fg="white",
                     command=calculation)
...
def enquiry1():
    ...
    box2 &  # 91;'values'] = &#91;'SELECT', 'TO LEARN PROGRAMMING', 'TO LEARN MACHINE LEARNING', 'FEE DETAILS']
    box2.current(0)
...
def installment2():
    if int(entry29.index("end")) & gt;int(0):
        fee_add()
    else:
